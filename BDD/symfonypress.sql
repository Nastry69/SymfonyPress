...
(5, 'Organiser un projet Symfony', 'Une bonne architecture permet un projet maintenable sur le long terme. Symfony impose une structure MVC claire : contrôleurs, entités, repositories, services. Les bundles permettent de modulariser les fonctionnalités.', 'architecture-symfony', 5, '2026-02-05 16:32:11', NULL, 2, 0),
...
(7, 'Bases du frontend moderne', 'HTML, CSS et JS sont les fondations du web. Les standards modernes incluent les Web Components, CSS Grid, et l\'API Fetch. Stimulus et Turbo permettent d\'ajouter de l\'interactivité sans framework lourd.', 'frontend-moderne', 4, '2026-02-05 16:32:11', NULL, 2, 0),
(8, 'Déployer une app Symfony', 'Docker, Nginx et CI/CD sont les piliers du déploiement moderne. Symfony s\'adapte à tous les environnements : serveur dédié, VPS, cloud, PaaS. Les bonnes pratiques incluent les variables d\'environnement et la gestion des secrets.', 'deployer-symfony', 3, '2026-02-05 16:32:11', NULL, 1, 0);
